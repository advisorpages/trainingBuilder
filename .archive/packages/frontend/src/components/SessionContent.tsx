          ...
          <section className="content-section cta-section">
            <div className="cta-content">
              ...
              <div className="cta-buttons">
                <a href="#registration" className="inline-flex items-center px-6 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                  Register Now
                </a>
                <a href="/" className="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                  View All Sessions
                </a>
              </div>
            </div>
