  ...
  return (
    <div className="session-card">
      ...
      {session.status === 'published' && (
        <div className="session-qr-code mt-3 pt-3 border-t border-gray-200">
          <QrCodeDisplay
      ...
      <div className="session-card-footer">
        <Link
          ...
          className="session-details-link inline-flex items-center justify-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
