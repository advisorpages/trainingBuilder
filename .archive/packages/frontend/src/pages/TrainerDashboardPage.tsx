    ...
    <div className="page">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <button onClick={() => logout()} className="btn" style={{ backgroundColor: '#dc3545' }}>
            Logout
          </button>
        </div>
      </div>
          ...
          <div>
            ...
            <div style={{ marginTop: '1rem' }}>
              <Link to={`/trainer/sessions/${summary.nextSession.id}`}>
                <button className="btn" style={{ backgroundColor: '#28a745' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
            ...
            <button
              ...
              onClick={() => {
                if (upcomingSessions.length > 0) {
                  window.location.href = `/trainer/sessions/${upcomingSessions[0].id}`;
                }
              }}
            >
              View Materials
          ...
          <div style={{
            ...
            <button
              ...
              onClick={() => {
                if (upcomingSessions.length > 0) {
                  window.location.href = `/trainer/sessions/${upcomingSessions[0].id}#coaching-tips`;
                }
              }}
            >
              View Tips
