...
export const ManageTopicsPage: React.FC = () => {
  ...
  const handleCreateTopic = async (data: CreateTopicRequest) => {
    try {
      ...
      showNotification('error', error.response?.data?.message || 'Failed to create topic');
    } finally {
  ...
  const handleDeleteTopic = async () => {
    ...
    try {
      ...
      showNotification('error', error.response?.data?.message || 'Failed to delete topic');
    } finally {
      setIsDeleting(false);
    }
  };
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Create and manage content topics for your sessions
              </p>
            </div>
